...
import ReservenB from "./ReservenB.js";
...
import U8A from "./U8A.js";
import U8B from "./U8B.js";
...
function AppRouter() {
  return (
    <Routes>
      ...
      <Route path="/reserven-b" element={<ReservenB />} />
      ...
      <Route path="/U8A" element={<U8A />} />
      <Route path="/U8B" element={<U8B />} />
      <Route path="/U7" element={<U7 />} />
